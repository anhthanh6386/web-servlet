...
//import model.User;
//
//@WebFilter("/videoservlet/*")
//public class AuthenticationFilterVideo implements Filter {
//
//    public AuthenticationFilterVideo() {
//    }
//
//	public void destroy() {
...
//		if(authUser == null||authUser.getAdmins()==true) {
